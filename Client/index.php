          ...
          <div class="row">
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number small">
                    <?php	
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "invite" => 0]]);
                     echo $query->count();
                    ?>	
			     </span>
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                    <?php	
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "invite" => 1]]);
                     echo $query->count();
                    ?>	
                    </span>
                </div><!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">
                    <?php	
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "completed" => 1]]);
                     echo $query->count();
                    ?>	
                    </span>
                </div><!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><?php echo $lang['payments']; ?></span>
                  <span class="info-box-number">
                        <?php
                        echo $currency_symbol.'&nbsp;'; 
                        $query = DB::getInstance()->sum("transactions", "payment", ["AND" => ["freelancerid" => $client->data()->clientid, "complete" => 1]]);
             ...
             <div class="panel-body">
                 ...
                 <div class="table-responsive">
                  <table  class="table table-bordered table-striped">
                    ...
                    <tbody>
				    <?php
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "invite" => "0", "delete_remove" => 0, "accepted" => 1], "LIMIT" => 4, "ORDER" => "date_added DESC"]);
                     if($query->count()) {
              ...
              <div class="row text-center no-gutter">
               ...
               <div class="col-xs-3 b-r b-light"> 
                ...
                <?php 	
				 ...
				 echo $q1->count();
                 ?>
				</span> <small class="text-muted m-b block"><?php echo $lang['new']; ?> <?php echo $lang['proposals']; ?></small>
               </div>
               <div class="col-xs-3">
			    <span class="h4 font-bold m-t block">
                <?php	
                 $query = DB::getInstance()->get("transactions", "*", ["AND" => ["freelancerid" => $client->data()->clientid, "complete" => 1]]);
                 echo $query->count();
                ?>	
           ...
           <section class="panel panel-default">
			...
			if ($query->count()) {
			 foreach($query->results() as $row) {
	            ...
	            $q1 = DB::getInstance()->sum("proposal", "budget", ["AND" => ["jobid" => $row->jobid, "freelancerid" => $row->freelancerid]]);
			...
			$outstanding = array_sum($r) - $pay;
			$percentage = $pay/array_sum($r) * 100;
			$percentage = round($percentage, 1);
            ?>
             <h4><small> <?php echo $lang['paid']; ?> <?php echo $lang['amount']; ?> : </small><?php echo $currency_symbol; ?> <?php echo $pay; ?></h4>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php echo $lang['monthly']; ?> <?php echo $lang['recap']; ?> <?php echo $lang['payments']; ?></h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
					 ...
					 <?php
					    ...
					    $q = "SELECT SUM(payment) AS value_sum FROM transactions WHERE freelancerid = $clientid AND complete = 1 AND DATE_FORMAT(date_added,'%M') = '$month'";
