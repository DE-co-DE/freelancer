                     ...
                     if($query->count()) {
						...
						if ($q1->count()) {
						 ...
						 if($q->count() === 1) {
					      ...
					      <a href="javascript:void(0)" onClick="alert(jobdelete.php?id=' . escape($row->id) . ')" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><span class="fa fa-trash"></span></a>';  
